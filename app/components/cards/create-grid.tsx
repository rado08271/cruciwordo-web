...
//     // FIXME: Unfortunatelly spacetime still does not support the processing of 'and' operation and Identity
//     const [newBoardsAll] = useTable(tables.board)
//     const newBoard = newBoardsAll.find((board) => board.createdBy.isEqual(
//         Identity.fromString(sessionStorage.getItem('identity') ?? "")
//     ))
