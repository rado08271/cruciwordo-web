...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Create a New Puzzle | Cruciwordo" },
    {
      name: "description",
      content:
        "Design your own word search puzzle in Cruciwordo. Create custom challenges, share with friends, and play together in real-time.",
    },
    {
      name: "keywords",
      content:
        "create crossword, word puzzle creator, custom word search, puzzle maker, multiplayer puzzle creator",
    },
    ...
    <>
      <Suspense
        fallback={
          <div
            className={
              "absolute flex w-screen h-screen backdrop-blur-sm justify-center items-center"
            }
          >
            <Loading />
          </div>
